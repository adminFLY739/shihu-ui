    ...
    <Modal v-model="formValidate" title="详细信息" width="500">
      ...
      >
        ...
        <FormItem label="反馈内容" prop="context">
          <!--          <Input style="width: 85%" v-model="form.context" type="textarea"  :autosize="{minRows: 3,maxRows: 5}"-->
          <!--          ></Input>-->
        ...
        <FormItem label="相关材料" prop="images">
          ...
          <div v-else>
            <span v-for="(item, index) in this.form.images.split(',')" :key="index">
              <Avatar shape="square" icon="ios-person" size="large" style="width: 250px;height: 450px;margin-right: 5px" :src="item"
              />
            </span>
          </div>
        </FormItem>
