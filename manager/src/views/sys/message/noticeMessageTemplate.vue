        ...
        <Card>
          <Tabs value="MESSAGE" @on-click="paneChange">
            ...
            <TabPane label="站内信列表" name="MESSAGE">
              <Form ref="searchForm" :model="searchMessageForm" inline :label-width="70" class="search-form" v-show="showSearch">
              ...
              <Row class="operation padding-row" >
                <Col span="22">
                  <Button @click="sendMessage" type="primary" icon="md-mail">发送消息</Button>
                </Col>
                <Col span="2">
                  <right-toolbar :showSearch.sync="showSearch" @queryTable="getMessage"></right-toolbar>
                </Col>
              </Row>
              <Table
                class="mr_10"
                ...
                :data="messageData"
              ></Table>
              <Row type="flex" justify="center" class="mt_10 mb_10 mr_10">
                <Page
            ...
            <TabPane label="通知类站内信" name="SETTING">
              <Table
                ...
                :data="noticeData"
              ></Table>
              <Row type="flex" justify="center" class="mt_10 mr_10">
                <Page
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getShopList() {
        this.loading = true;
        API_Shop.getShopListData(this.searchForm).then((res) => {
          this.loading = false;
          if (res.success) {
        ...
        this.messageSendForm =
          {
            ...
            userIds: [],
            userNames: [],
            tenantId: this.searchMessageForm.tenantId,
          }
      },
      //管理员发送站内信提交
      sendMessageSubmit() {
    ...
    mounted() {
      if(!this.userInfo.isSuper&&this.userInfo.tenantId){
        this.searchMessageForm.tenantId=this.userInfo.tenantId;
      }
      this.init();
    },
  };
