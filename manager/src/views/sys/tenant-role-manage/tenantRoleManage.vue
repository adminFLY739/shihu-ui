  ...
  <div class="search">
    <Card>
      ...
      <Row type="flex" justify="center" class="mt_10">
        <Page :current="pageNumber" :total="total" :page-size="pageSize" @on-change="changePage" @on-page-size-change="changePageSize" :page-size-opts="[10, 20, 50]" size="default" show-total
  ...
  methods: {
    ...
    init() {
      if(!this.userInfo.isSuper&&this.userInfo.tenantId){
        this.roleForm.tenantId=this.userInfo.tenantId;
      }
      this.getRoleList();
      // 获取所有菜单权限树
      this.getPermList();
    ...
    getRoleList() {
      ...
      let params = {
        ...
        order: this.sortType,
        tenantId:this.roleForm.tenantId,
      };
