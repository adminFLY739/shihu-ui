  ...
  <div class="search">
    <Card>
      ...
      <Row class="operation padding-row" >
        <Col span="22">
          ...
          <Button @click="resetPass" icon="md-lock">重置密码</Button>
        </Col>
        <Col span="2">
    ...
    >
      <Form ref="form" :model="form" :label-width="70" :rules="formValidate">
        ...
        <FormItem label="租户区域" prop="roles" v-if="form.roles.indexOf('1668082517050101761')!==-1||this.userInfo.tenantId" >
          <Select v-model="form.tenantId" :disabled="!this.userInfo.isSuper&&this.userInfo.tenantId">
