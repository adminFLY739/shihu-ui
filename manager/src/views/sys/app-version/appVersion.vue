<template>
  <div class="search">
    <Card>
      <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form" @keydown.enter.native="handleSearch" v-show="showSearch">
      ...
      <Row class="operation padding-row" >
        <Col span="22">
          <Button class="mt_10 mb_10" @click="addAppVersion" type="primary" icon="md-add">添加</Button>
        </Col>
        <Col span="2">
