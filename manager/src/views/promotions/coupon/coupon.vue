  ...
  <div class="search">
    <Card>
      ...
      <Row class="operation padding-row" v-if="getType !== 'ACTIVITY'">
        <Col span="22" >
          <Button @click="add" type="primary" icon="md-add">添加优惠券</Button>
          <Button @click="delAll" icon="md-power">批量关闭</Button>
          <Button @click="receivePage()" type="info" icon="md-bookmarks">优惠券领取记录</Button>
        </Col>
        <Col span="2">
