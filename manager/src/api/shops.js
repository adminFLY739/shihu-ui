...
//禁用店铺
export const disableShop = (id,tenantId) => {
    return putRequest(`/store/store/disable/${id}/${tenantId}`)
}
//开启店铺
export const enableBrand = (id,tenantId) => {
    return putRequest(`/store/store/enable/${id}/${tenantId}`)
}

//查询店铺详细
export const getShopDetailData = (id,tenantId, params) => {
    return getRequest(`/store/store/get/detail/${id}/${tenantId}`, params)
}
...
//审核店铺
export const shopAudit = (id,tenantId, passed) => {
    return putRequest(`/store/store/audit/${id}/${tenantId}/${passed}`)
}
