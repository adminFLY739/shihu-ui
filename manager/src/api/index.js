...
// 获取业务接口统计
export const getServiceStatistics = (params,tenantId) => {
  return getRequest(`/statistics/service/getByPage/${tenantId}`, params);
};
...
// 系统设置
export const getSetting = (key,tenantId) => {
  return getRequest(`/setting/setting/get/${key}/${tenantId}`);
};
// 更新系统配置
export const setSetting = (key, params,tenantId) => {
  return putRequestWithNoForm(`/setting/setting/put/${key}/${tenantId}`, params);
};
...
export const getHotWords = (params) => {
  return getRequest(`/hotwords/hotwords`,params);
};
