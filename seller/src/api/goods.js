...
export const getGoodsData = (params) => {
  return getRequest('/goods/goods/goodsData', params)
}
...
// 添加发货地
export const addShipments = (params) => {
  return postRequest(`/goods/shipments`, params);
};
// 分页发货地
export const getShipmentsList = (params) => {
  return getRequest(`/goods/shipments`, params);
};
// 编辑发货地
export const updateShipments = (id, params) => {
  return putRequest(`/goods/shipments/${id}`, params);
};
// 删除发货地
export const delShipments = (ids) => {
  return deleteRequest(`/goods/shipments/${ids}`);
};

//添加发货员
export const addShipmentsClerk = (params) => {
  return postRequest(`/goods/shipments/shipmentsClerk`,params);
};

//添加发货员
export const getShipmentsClerkList = (params) => {
  return getRequest(`/goods/shipments/getShipmentsClerk`,params);
};
