...
Vue.prototype.wapLinkToDelivery = function(deliveryCode, deliveryPassword) {
  // app端二维码
  return `${WAP_URL}/pages/mine/card/cardInfo?deliveryCode=${deliveryCode}&deliveryPassword=${deliveryPassword}`;
};
