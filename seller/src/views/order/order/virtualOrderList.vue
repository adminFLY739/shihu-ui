    ...
    <Card>
      <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form" v-show="showSearch">
        ...
        <Form-item label="用户名称" prop="buyerName">
          <Input type="text" v-model="searchForm.buyerName" clearable placeholder="请输入用户名称" style="width: 160px" />
        </Form-item>
  ...
  methods: {
    ...
    async orderVerification() {
      ...
      if (result.success && result.result!==null) {
        ...
        this.$Message.warning("核验码错误,商品未找到")
        return;
      }
    },
    // 初始化数据
