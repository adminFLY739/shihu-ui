...
export default {
  ...
  methods: {
    ...
    getCookie() {
      const username = Cookies.get("seller_username");
      const password = Cookies.get("seller_password");
      const rememberMe = Cookies.get('seller_rememberMe')
      this.form = {
        ...
        this.$refs.usernameLoginForm.validate(valid => {
          if (valid) {
            ...
            if (this.form.rememberMe) {
              Cookies.set("seller_username", this.form.username, { expires: 30 });
              Cookies.set("seller_password", encrypt(this.form.password), { expires: 30 });
              Cookies.set('seller_rememberMe', this.form.rememberMe, { expires: 30 });
            } else {
              Cookies.remove("seller_username");
              Cookies.remove("seller_password");
              Cookies.remove('seller_rememberMe');
            }
            let fd = new FormData();
